	...
	<div>
		...
		<main class="main">
			...
			<script_amp :src="GamePathScript" v-if="GameNumberPostOnQuery < data.body.slots.length">
				<app_slot_card_amp :value="data.body.slots" post_type="category" post_url="progressive" />
			</script_amp>
			<app_slot_card_amp
				:value="data.body.slots"
				post_type="category"
				post_url="progressive"
...
import app_slot_card_amp from '~/components/slot_loop/app_slot_loop_card_amp'
