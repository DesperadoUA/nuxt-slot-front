  ...
  <div>
    <app_header_amp :logo="data.body.options.logo" :menu_links="data.body.settings.header_menu" />
        <main class="main">
            ...
            <app_heading_amp v-if="data.body.casino.length !== 0" :value="{
            ...
            <app_heading_amp v-if="data.body.slots.length !== 0" :value="{
...
<script>
    ...
    export default {
        ...
        components: {app_intro_amp, AuthorLinkContainerAmp, app_vendor_card_amp, app_heading_amp, app_vendor_casino_amp, app_slot_loop_card_amp},
