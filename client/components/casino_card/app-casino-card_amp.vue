...
<div class="container container2">
    <div class="casino-card">
        <div class="casino-card__logo">
            <amp-img :src="value.thumbnail" :alt="value.title" width="245" height="140" />
        </div>
        ...
        <div class="casino-card-param">
            <div :class="value.live_casino == 1 ? 'casino-card-param__item': 'casino-card-param__item disabled'">
                <amp-img class="casino-card-param__img"
                     src="/img/fire.svg" width="17" height="19" alt="" />
            ...
            <div :class="value.live_casino == 1 ? 'casino-card-param__item': 'casino-card-param__item disabled'">
                <amp-img class="casino-card-param__img"
                     src="/img/casino.svg" width="19" height="19" alt="" />
        ...
        <div class="casino-card-button_wrapper">
            <a class="casino-card__cta btn-tertiary" :href="getRef(value)">{{translates.GO_TO[config.LANG]}}</a>
        </div>
    </div>
</div>
</template>
