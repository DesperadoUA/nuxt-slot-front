	...
	<div class="container container2">
		<div class="casino-card">
				...
				<div
					:class="
						value.live_casino == 1
							...
							: 'casino-card-param__item disabled'
					"
				>
					<amp-img
						class="casino-card-param__img"
						src="/img/fire.svg"
						width="17"
						height="19"
						alt=""
			...
			<div class="casino-card-bonus">
				...
				<span class="casino-card-bonus__ttl">{{
			...
			<div class="casino-card-bonus">
				...
				<div class="casino-card-bonus__wager">
					{{ value.freespins_wagering }}
				</div>
			</div>
			<div class="casino-card-button_wrapper">
				<a class="casino-card__cta btn-tertiary" :href="getRef(value)">{{
