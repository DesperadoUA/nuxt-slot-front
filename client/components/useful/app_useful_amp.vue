			...
			<div class="useful-categories__container">
				<div class="useful-group">
					...
					<NuxtLink
						...
						class="news-item"
						v-for="(item, index) in value.news"
						:key="index"
					>
				...
				<div class="useful-group">
					...
					<NuxtLink
						...
						:to="`${config.AMP_PREFIX}${item.permalink}`"
						class="blog-item"
						v-for="(item, index) in value.blog"
						:key="index"
					>
				...
				<div class="useful-group">
					<h3 class="useful-group__ttl">
						{{ translates.INTERVIEW[config.LANG] }}
					</h3>
					...
					<NuxtLink
						...
						:to="`${config.AMP_PREFIX}${item.permalink}`"
						class="blog-item"
						v-for="(item, index) in value.interview"
						:key="index"
					>
						<span class="blog-item__media">
							<amp-img :src="item.thumbnail" alt="" width="344" height="190" />
