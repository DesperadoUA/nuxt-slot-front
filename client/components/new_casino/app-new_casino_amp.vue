    ...
    <div class="slots">
        <div class="container">
            <div class="slots__heading">
                ...
                <NuxtLink no-prefetch :to="`${config.AMP_PREFIX}/reviews`" class="link-primary">{{translates.ALL_CASINO[config.LANG]}}</NuxtLink>
            </div>
                ...
                <NuxtLink no-prefetch :to="`${config.AMP_PREFIX}${item.permalink}`"
                    ...
                    <div class="slot-item__rating">
                        <div class="circle-rating">
                            ...
                            <amp-img class="circle-rating__logo" :src="item.icon" alt="" width="62" height="62" />
                        </div>
