<template>
	<amp-script
		layout="container"
		:src="`${config.BASE_URL[config.LANG]}/js/amp-casino.js`"
		class="sample"
	>
		<div class="casinos">
			<div class="container">
					...
					>
						...
						<div class="casino-item__content">
							<div class="casino-param" v-if="item.close !== 1">
								<div
									:class="
										item.regular_offers == 1
											? 'casino-param__item'
											: 'casino-param__item disabled'
									"
								>
									<amp-img
										class="casino-param__img"
										src="/img/fire.svg"
										width="17"
										height="17"
										alt=""
							...
							<div class="casino-bonuses">
								<div class="casino-bonus">
									<span class="casino-bonus__value" style="color: #ffe600;">{{
										item.bonus
									}}</span>
									<span class="casino-bonus__ttl">{{
										translates.WELCOME_BONUS[config.LANG]
									}}</span>
								...
								<div class="casino-bonus">
									<span class="casino-bonus__value" style="color: #12d4ff;">{{
										item.freespins
									}}</span>
									<span class="casino-bonus__ttl">{{
