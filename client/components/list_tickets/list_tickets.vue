    ...
    <section class="ticket_list">
        <div class="container">
            ...
            <div class="ticket_list_wrapper">
                <div :class="item.status_accordeon | accordeonState" v-for="item in currentPosts" :key="item.id"  @click="activate(item)">
                    ...
                    <div class="ticket_list_description">
                        <div class="ticket_list_description_text" v-html="item.content">
                        </div>
                        <div class="ticket_list_description_comment" v-if="item.admin_comment.length !== 0">
    ...
    export default {
        ...
        filters: {
            accordeonState(status) {
                const str = status === 'close' ? 'ticket_list_item' : 'ticket_list_item active'
                return str
            }
        },
        computed: {
