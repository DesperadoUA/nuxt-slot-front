		...
		<div class="container">
			<div class="casino-categories__container">
				<div class="casino-group">
					<h3 class="casino-group__ttl">
						{{ translates.HIGHEST_RATING[config.LANG] }}
					</h3>
					<NuxtLink
						:to="item.permalink"
					...
					>
						...
						<div class="casino-group-item__content">
							<div class="casino-group-item__close" v-if="item.close !== 0">
								{{ close }}
							</div>
				...
				<div class="casino-group">
					<h3 class="casino-group__ttl">
						{{ translates.NEW_CASINO[config.LANG] }}
					</h3>
					<NuxtLink
						:to="item.permalink"
				...
				<div class="casino-group">
					<h3 class="casino-group__ttl">
						{{ translates.POPULAR_CASINO[config.LANG] }}
					</h3>
					<NuxtLink
						:to="item.permalink"
...
.casino-categories__container {
	...
	.casino-group {
		width: calc(
			var(--casino-categories-width) - var(--casino-categories-gutters)
		);
		flex-basis: calc(
			var(--casino-categories-width) - var(--casino-categories-gutters)
		);
