...
class DAL_Forum {
    static addCandidate(data) {
        return axios.post(config.API_URL[config.LANG]+'forum-user/add-candidate', data)
    }
    static login(data) {
    ...
    static checkUser(data) {
        return axios.post(config.API_URL[config.LANG]+'forum-user/check-user', data)
    }
    static changePassword(data) {
        return axios.post(config.API_URL[config.LANG]+'forum-user/change-password', data)
    }
    static deleteAccount(data) {
        return axios.post(config.API_URL[config.LANG]+'forum-user/delete-account', data)
    }
    ...
    static getUserTickets(data) {
        return axios.post(config.API_URL[config.LANG]+'tickets/user-tickets', data)
    }
}
