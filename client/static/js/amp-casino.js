			...
			for (let i = counter * postsOnQuery; i < length; i++) {
				...
				if (posts[i].close !== 1) {
					html += `<div class="casino-param">
                                    ...
                                    <div class="${
																			posts[i].live_chat == 1 ? 'casino-param__item' : 'casino-param__item disabled'
																		}">
                                    ...
                                    <div class="${
																			posts[i].live_casino == 1 ? 'casino-param__item' : 'casino-param__item disabled'
																		}">
                                    ...
                                    <div class="${
																			posts[i].vip_program == 1 ? 'casino-param__item' : 'casino-param__item disabled'
																		}">
