export default {
	...
	SUCCESS_MESSAGE: {
		UA:
			'Для підтвердження реєстрації вам на пошту надіслано листа з посиланням для переходу',
		RU:
			'Для подтверждения регистрации вам на почту отправлено письмо с ссылкой для перехода'
	},
	CLOSED: {
		UA: 'Закрито',
		RU: 'Закрыто'
